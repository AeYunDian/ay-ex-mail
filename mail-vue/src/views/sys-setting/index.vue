            ...
            <div class="card-content">
              <div class="concerning-item">
                ...
                <el-badge is-dot :hidden="!hasUpdate">
                  <el-button @click="jump('https://github.com/AeYunDian/ay-ex-mail/')">
                    {{ currentVersion }}
                    <template #icon>
              ...
              <div class="concerning-item">
                ...
                <div class="community">
                  <el-button @click="jump('https://github.com/AeYunDian/ay-ex-mail/discussions')">
                    Github
                    <template #icon>
              ...
              <div class="concerning-item">
                <span>{{ $t('support') }} : </span>
                <el-button @click="jump('https://undz.cn/sponsors/')">
                  {{ t('supportDesc') }}
                  <template #icon>
...
function getUpdate() {
  ...
  axios.get('https://api.github.com/repos/AeYunDian/ay-ex-mail/releases/latest').then(({data}) => {
